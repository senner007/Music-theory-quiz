...
export const MelodyPattern_004: IMelodyGeneratorBase = class extends MelodyGeneratorBase {
    ...
    public melody() {
        ...
        const isUnison = (note1: TNoteAllAccidentalOctave, note2: TNoteAllAccidentalOctave) =>
            interval_distance(note1, note2) === "1P"
        ...
        return this.pattern_executor(
            [
...

                {
                    description: "CadenceSoprano",
                    conditions: [
                        () => isSecond(previousNote!, sopranoNote) || isUnison(previousNote!, sopranoNote)
                    ],
                    isCadence: true,
                    isFallback: false,
                ...
                },
                {
                    description: "CadenceAlto",
                    conditions: [
                        () => isSecond(previousNote!, altoNote) || isUnison(previousNote!, altoNote)
                    ],
                    isCadence: true,
                    isFallback: false,
                    rhythm: [
                ...
                },
                {
                    ...
                    conditions: [
                        () => tenorNote !== undefined,
                        () => isSecond(previousNote!, tenorNote!) || isUnison(previousNote!, tenorNote!)
                    ],
                    isCadence: true,
                    isFallback: false,
                    rhythm: [
